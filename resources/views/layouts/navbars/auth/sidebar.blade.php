<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">CV Sarana Perintis Jaya</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a href="{{ route('orders.index') }}" class="nav-link {{ Route::currentRouteName() == 'orders' ? 'active' : '' }}">
            ...
            <li class="nav-item">
              <a href="{{ route('trucks.index') }}" class="nav-link {{ Route::currentRouteName() == 'trucks' ? 'active' : '' }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="tim-icons icon-single-02"></i>
                </div>
            ...
            <li class="nav-item">
              <a href="{{ route('drivers.index') }}" class="nav-link {{ Route::currentRouteName() == 'drivers' ? 'active' : '' }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="tim-icons icon-single-02"></i>
                </div>
            ...
            <li class="nav-item">
              <a href="{{ route('clients.index') }}" class="nav-link {{ Route::currentRouteName() == 'clients' ? 'active' : '' }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="tim-icons icon-single-02"></i>
                </div>
