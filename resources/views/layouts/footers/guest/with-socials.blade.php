          ...
          <div class="row">
              <div class="col-8 mx-auto text-center mt-1">
                  <p class="mb-0 text-secondary">
                      Copyright © {{ now()->year }} Transport Management System by <a style="color: #252f40;" href="https://www.creative-tim.com"
                          class="font-weight-bold ml-1" target="_blank">CV. SARANA PERINTIS JAYA</a><a style="color: #252f40;"
              </div>
              </p>
          </div>
      </div>
